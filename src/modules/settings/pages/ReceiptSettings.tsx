    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <label className="flex items-center justify-between">
          <span>Show Logo</span>
          <input type="checkbox" checked={settings.showLogo} onChange={(e) => update("showLogo", e.target.checked)} />
        </label>
        ...
        <label className="flex items-center justify-between">
          ...
          <input type="checkbox" checked={settings.showPhone} onChange={(e) => update("showPhone", e.target.checked)} />
        </label>

        <label className="flex items-center justify-between">
          <span>Show Email</span>
          <input type="checkbox" checked={settings.showEmail} onChange={(e) => update("showEmail", e.target.checked)} />
        </label>
      </div>

      <div>
        <label className="block mb-2 font-medium">Paper Width</label>

        <select
          value={settings.paperWidth}
          onChange={(e) => update("paperWidth", e.target.value as "58mm" | "80mm")}
      ...
      <div>
        <label className="block mb-2">Footer Line 1</label>
      ...
      <div>
        <label className="block mb-2">Footer Line 2</label>
      ...
      <div>
        <label className="block mb-2">Footer Line 3</label>
      ...
      <button onClick={save} className="rounded-lg bg-indigo-600 px-5 py-2 text-white hover:bg-indigo-700">
        Simpan
      </button>
    </div>
  );
